...
def upload_natural_stories(register_plugin=False):
    # adapted from
    ...
    data_path = Path("~/naturalstories") / 'naturalstories_RTS'
    data_file = data_path / 'processed_RTs.tsv'
    ...
    voc_item_ID = np.array(table['item'])
    voc_zone_ID = np.array(table['zone'])
    voc_word = np.array(table['word'])
    nItem = np.array(table['nItem'])
    meanItemRT = np.array(table['meanItemRT'])
    sdItemRT = np.array(table['sdItemRT'])
    gmeanItemRT = np.array(table['gmeanItemRT'])
    gsdItemRT = np.array(table['gsdItemRT'])
    ...
    assembly = BehavioralAssembly(reading_times,
                                  ...
                                  coords={'word': ('presentation', voc_word),
                                          ...
                                          'nItem': ('presentation', nItem),
                                          'meanItemRT': ('presentation', meanItemRT),
                                          'sdItemRT': ('presentation', sdItemRT),
                                          'gmeanItemRT': ('presentation', gmeanItemRT),
                                          'gsdItemRT': ('presentation', gsdItemRT),
